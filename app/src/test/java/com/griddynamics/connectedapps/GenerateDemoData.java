...
public class GenerateDemoData {
    public static final String CLIENT_ID = "projects/gd-gcp-rnd-connected-apps/locations/europe-west1/registries/europe-registry/devices/g-pKztLn06yvdeNSFjCe6n";
...
// For lazier types (like me):
    ...
    public void main() throws JSONException, IOException, URISyntaxException, InterruptedException {
        ...
        String deviceId = "pKztLn06yvdeNSFjCe6n";
